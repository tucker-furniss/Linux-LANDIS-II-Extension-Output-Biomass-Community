...
Source: {#BuildDir}\Landis.Extension.Output.BiomassCommunity-v2.dll; DestDir: {#ExtDir}; Flags: replacesameversion
Source: {#BuildDir}\Landis.Extension.Output.BiomassCommunity-v2.pdb; DestDir: {#ExtDir}; Flags: replacesameversion
...
#define InfoTxt "Output Biomass Community 2.0.txt"
